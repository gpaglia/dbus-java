...
public class MarshallingFileDescriptorTest {
  ...
  @BeforeEach
  public void before() throws DBusException, IOException {
  ...
  @Test
  @Disabled("Until FIleDescriptor -- type h -- fixed")
  public void testFileDescriptor() throws DBusException, IOException {
    IFileDescriptor remoteObject = clientConn.getRemoteObject("foo.bar.TestFileDescriptor", TEST_OBJECT_PATH, IFileDescriptor.class);

    //noinspection ConstantConditions
    assertTrue(remoteObject instanceof IFileDescriptor, "Expected instance of GetFileDescriptor");

    FileDescriptor fileDescriptor = remoteObject.getFileDescriptor();
