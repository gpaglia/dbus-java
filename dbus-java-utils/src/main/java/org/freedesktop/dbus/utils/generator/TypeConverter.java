...
public class TypeConverter {
   ...
   */
  private static String convertJavaType(String _fqcn, @SuppressWarnings("SameParameterValue") boolean _usePrimitives) {
    if (_fqcn == null) {
      return null;
    }
   ...
   */
  private static Map<String, List<String>> getTypeAdv(
      Type _type,
   ...
   * @throws DBusException in case of exception
   */
